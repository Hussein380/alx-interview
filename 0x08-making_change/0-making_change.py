...
"""Module containing the make_change function to solve the coin change problem."""


def make_change(coins, total):
    """
    Determine the minimum number of coins needed to achieve the given total amount.
    ...
    int: The fewest number of coins needed to meet the total. 
         ...
         Returns -1 if it's not possible to meet the total with the available coins.
    """
    ...
    # If we exit the loop and total is not zero, return -1 (change can't be made)
    return -1
